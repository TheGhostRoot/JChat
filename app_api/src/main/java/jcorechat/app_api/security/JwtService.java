...
public class JwtService {
    ...
    public String generateGlobalJwt(final Map<String, Object> claims, final String data, final boolean encrypted) {
    ...
    public String generateUserJwt(final Map<String, Object> claims, final String data,
    ...
    public String generateRandomUserSign() {
